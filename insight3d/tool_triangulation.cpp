...
{
        printf("modelling menu craetion; File:tool_triangulation.cpp\n");
...
{
        printf("triangulating all user vertices;call to action_triangulate_vertices(); Funtion:tool_triangulate_vertices File:tool_triangulation.cpp");
